...
{
    return FormatParagraph(_("Copyright (c) Coin Sciences Ltd - www.gamechain.com")) + "\n" +
           "\n" +
           ...
           "\n" +
           FormatParagraph(_("Full terms are shown at: http://www.gamechain.com/terms-of-service/")) +
           "\n";
